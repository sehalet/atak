 ...
 * Version: v1.1.8
 * Last Updated: 2023-07-24 (Modified by Gemini on 2025-06-28 for textarea resize)
 * Author: RedAlert
...
// Helper: Window Content (Burada değişiklik yapıldı)
function prepareWindowContent(windowBody) {
    ...
    const windowStyle = `
		<style>
			...
			/* BURADAKİ TEXTAREA STİLİ GÜNCELLENDİ */
            textarea {
                width: 100%;
                min-height: 80px; /* Minimum yükseklik */
                box-sizing: border-box;
                padding: 5px;
                resize: vertical; /* Sadece dikey yönde yeniden boyutlandırmaya izin ver */
            }
